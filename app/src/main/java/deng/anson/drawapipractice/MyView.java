package deng.anson.drawapipractice;
...
//        arcPaint.setStrokeWidth((float) 3);
//        arcPaint.setStyle(Paint.Style.STROKE); //FILL
//        RectF rect = new RectF(0, 0, getWidth(), getHeight());
//        canvas.drawArc(rect, 0, 60, false, arcPaint);


        // draw line
//        canvas.drawLine(0, 0, getWidth(), getHeight(), mPaint);
//        float[] lines = {0, 0, 0, getHeight(),
//                        0, 0, getWidth(), 0,
//                        0, 0, getWidth(), getHeight()};
//        canvas.drawLines(lines, 0, 12, mPaint);

        // draw oval
//        RectF rect = new RectF(0, 0, getWidth()/2, getHeight());
